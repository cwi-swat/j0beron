...
import j0beron.visitor.ast.decl.*;
import j0beron.visitor.ast.expr.*;
import j0beron.visitor.ast.stat.*;
import j0beron.visitor.ast.type.*;
...
class Oberon0Parser implements Oberon0Tokens {
    ...
    private j0beron.visitor.ast.ASTNode[] yysv;
    private j0beron.visitor.ast.ASTNode yyrv;

    public boolean parse() {
        int yyn = 0;
        yysp = 0;
        yyst = new int[yyss];
        yysv = new j0beron.visitor.ast.ASTNode[yyss];
    ...
    protected void yyexpand() {
        ...
        j0beron.visitor.ast.ASTNode[] newyysv = new j0beron.visitor.ast.ASTNode[2*yyst.length];
