...
import j0beron2.ast.expr.*;
import j0beron2.ast.stat.*;
import j0beron2.ast.decl.*;
import j0beron2.ast.type.*;
...
class Oberon0Parser implements Oberon0Tokens {
    ...
    private j0beron2.ast.ASTNode[] yysv;
    private j0beron2.ast.ASTNode yyrv;

    public boolean parse() {
        int yyn = 0;
        yysp = 0;
        yyst = new int[yyss];
        yysv = new j0beron2.ast.ASTNode[yyss];
    ...
    protected void yyexpand() {
        ...
        j0beron2.ast.ASTNode[] newyysv = new j0beron2.ast.ASTNode[2*yyst.length];
