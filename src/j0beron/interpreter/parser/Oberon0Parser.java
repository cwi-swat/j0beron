...
import j0beron.interpreter.ast.decl.*;
import j0beron.interpreter.ast.expr.*;
import j0beron.interpreter.ast.stat.*;
import j0beron.interpreter.ast.type.*;
...
class Oberon0Parser implements Oberon0Tokens {
    ...
    private j0beron.interpreter.ast.ASTNode[] yysv;
    private j0beron.interpreter.ast.ASTNode yyrv;

    public boolean parse() {
        int yyn = 0;
        yysp = 0;
        yyst = new int[yyss];
        yysv = new j0beron.interpreter.ast.ASTNode[yyss];
    ...
    protected void yyexpand() {
        ...
        j0beron.interpreter.ast.ASTNode[] newyysv = new j0beron.interpreter.ast.ASTNode[2*yyst.length];
